...
ggplot(long_data_1, aes(x = group, y = Expression, color = group, shape = group, fill = group)) +
  ...
  theme_minimal() +
  labs(title = "Transcripts of TMEM178A Expressions in AD vs AsymAD (MSBB)",
...
ggsave(filename = file.path(path, "TMEM178A_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
...
ggplot(long_data_1, aes(x = group, y = Expression, color = group, shape = group, fill = group)) +
  ...
  geom_jitter(size = 2, alpha = 0.7, position = position_jitter(width = 0.2)) +
  theme_minimal() +
  labs(title = "Transcripts of ADAMTS2 Expressions in AD vs AsymAD (MSBB)",
       x = "Group", y = "Expression") +
  scale_color_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  scale_fill_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  geom_signif(comparisons = list(c("AD", "AsymAD")), 
...
ggsave(filename = file.path(path, "ADAMTS2_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
ggplot(long_data_1, aes(x = group, y = Expression, color = group, shape = group, fill = group)) +
  ...
  geom_jitter(size = 2, alpha = 0.7, position = position_jitter(width = 0.2)) +
  theme_minimal() +
  labs(title = "Transcripts of CLDN5 Expressions in AD vs AsymAD (MSBB)",
       x = "Group", y = "Expression") +
  scale_color_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  scale_fill_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  geom_signif(comparisons = list(c("AD", "AsymAD")), 
...
ggsave(filename = file.path(path, "CLDN5_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
ggsave(filename = file.path(path, "PDIK1L_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
fitteddata_2 <- rbind(fitteddata,enst_548.5)
...
ggsave(filename = file.path(path, "ENPP5_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
fitteddata_2 <- rbind(fitteddata, enst_598.8)
...
ggsave(filename = file.path(path, "GNG4_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
transcripts_of_interest <- c("ENST00000223061.6", "ENST00000496269.1", "ENST00000486440.5", "ENST00000472348.1", "ENST00000487172.1", "ENST00000468214.1", "ENST00000460002.1", "ENST00000490909.1")
...
ggsave(filename = file.path(path, "PCOLCE_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
ggplot(long_data_1, aes(x = group, y = Expression, color = group, shape = group, fill = group)) +
  ...
  geom_jitter(size = 2, alpha = 0.7, position = position_jitter(width = 0.2)) +
  theme_minimal() +
  labs(title = "Transcripts of MRPL1 Expressions in AD vs AsymAD (MSBB)",
       x = "Group", y = "Expression") +
  scale_color_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  scale_fill_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  geom_signif(comparisons = list(c("AD", "AsymAD")), 
...
ggsave(filename = file.path(path, "MRPL1_Expressions_AD_vs_AsymAD_MSBB_DTE.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
