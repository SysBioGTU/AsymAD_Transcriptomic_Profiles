...
ggsave(filename = file.path(path, "GNG4_Expressions_AD_vs_AsymAD_MSBB_DET.tiff"),
       plot = last_plot(),
...
ggsave(filename = file.path(path, "MRPL1_Expressions_AD_vs_AsymAD_MSBB_DET.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
ggsave(filename = file.path(path, "ADAMTS2_Expressions_AD_vs_AsymAD_MSBB_DET.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
...
ggplot(long_data_1, aes(x = group, y = Expression, color = group, shape = group, fill = group)) +
  ...
  geom_jitter(size = 2, alpha = 0.7, position = position_jitter(width = 0.2)) +
  theme_minimal() +
  labs(title = "Transcripts of PCOLCE Expressions in AD vs AsymAD (MSBB)",
       x = "Group", y = "Expression") +
  scale_color_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  scale_fill_manual(values = c("AD" = "skyblue", "AsymAD" = "darkblue")) +
  geom_signif(comparisons = list(c("AD", "AsymAD")), 
...
ggsave(filename = file.path(path, "PCOLCE_Expressions_AD_vs_AsymAD_MSBB_DET.tiff"),
       plot = last_plot(),
       width = 9, height = 7, device = "tiff", dpi = 600)
