...
df <- data.frame(
  ...
  log10_p_value = c(3.05868433925078, 3.7161123436789, 1.43547333808953,
                    ...
                    2.09714718211474, 2.30812637688591),  # negative log10 adjusted p-values of enriched terms
...
df <- data.frame(
  ...
  log10_p_value = c(3.00313163545272, 1.41508876249324, 4.83288946451113,
                    ...
                    2.32289652363223),  # negative log10 adjusted p-values of enriched terms
